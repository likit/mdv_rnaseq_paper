...
degenes.table<-read.table('line6ui_select_deu_degenes.ensembl.txt',
...
df = lapply(KEGG_SIG$category, get_genes_kegg, annotated.degenes, "line6ui_select_deu_goseq_KEGG_genes")
...
write.table(KEGG_SIG, 'line6ui_select_deu_combined.KEGG.txt', sep='\t', row.names=F, quote=F)
